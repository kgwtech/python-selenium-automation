...
class Page:
    ...
    # Base methods to be utilized in methods in other Page Objects
    """ Base Methods"""  # ////////////////////////////////////////////////////////////////////////////////////////////
    ...
    # def wait_visibility_all_elements(self):
    #     self.wait.until(
    #         EC.visibility_of_all_elements_located(),
    #         message=f"All elements not visible."
    #     )
    ...
    def verify_text(self, expected_text, *locator):
        ...
        assert expected_text == actual_text, \
            f"Expected text '{expected_text}' not actual '{actual_text}'"
